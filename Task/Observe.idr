...
inputs (Done _)                 @{DoneIsNormal}         = []
inputs (Choose t1 t2)           @{ChooseIsNormal n1 n2} = inputs t1 ++ inputs t2
inputs (Fail)                   @{FailIsNormal}         = []
inputs (Step t1 e2)             @{StepIsNormal n1}      = inputs t1
