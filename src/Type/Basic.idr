...
data IsBasic : Type -> Type where
  ...
  FinIsBasic    : (n : Nat) -> IsBasic (Fin n)
  UnitIsBasic   : IsBasic ()
...
Eq (IsBasic a) where
  ...
  FinIsBasic n1       == FinIsBasic n1       = True
...
uninhBoolFin : Not (BoolIsBasic = FinIsBasic _)
uninhBoolFin Refl impossible
...
uninhIntFin : Not (IntIsBasic = FinIsBasic _)
uninhIntFin Refl impossible
...
uninhStringFin : Not (StringIsBasic = FinIsBasic _)
uninhStringFin Refl impossible
...
uninhFinUnit : Not (FinIsBasic _ = UnitIsBasic)
uninhFinUnit Refl impossible

uninhFinSymbol : Not (FinIsBasic _ = SymbolIsBasic _)
uninhFinSymbol Refl impossible

uninhFinPair : Not (FinIsBasic _ = PairIsBasic _ _)
uninhFinPair Refl impossible
...
finNeq : Not (n1 = n2) -> Not (FinIsBasic n1 = FinIsBasic n2)
finNeq cntr Refl = cntr Refl
...
decBasic BoolIsBasic         (FinIsBasic n2)     = No uninhBoolFin
...
decBasic IntIsBasic          (FinIsBasic n2)     = No uninhIntFin
...
decBasic StringIsBasic       (FinIsBasic n2)     = No uninhStringFin
...
decBasic (FinIsBasic n1)     BoolIsBasic         = No (negEqSymBasic uninhBoolFin)
decBasic (FinIsBasic n1)     IntIsBasic          = No (negEqSymBasic uninhIntFin)
decBasic (FinIsBasic n1)     StringIsBasic       = No (negEqSymBasic uninhStringFin)
decBasic (FinIsBasic n1)     (FinIsBasic n2)     with (n1 ?= n2)
  decBasic (FinIsBasic n1)     (FinIsBasic n1)     | Yes Refl = Yes Refl
  decBasic (FinIsBasic n1)     (FinIsBasic n2)     | No  cntr = No (finNeq cntr)
decBasic (FinIsBasic n1)     UnitIsBasic         = No uninhFinUnit
decBasic (FinIsBasic n1)     (SymbolIsBasic s2)  = No uninhFinSymbol
decBasic (FinIsBasic n1)     (PairIsBasic x1 y2) = No uninhFinPair
...
decBasic UnitIsBasic         (FinIsBasic n2)     = No (negEqSymBasic uninhFinUnit)
...
decBasic (SymbolIsBasic s1)  (FinIsBasic n2)     = No (negEqSymBasic uninhFinSymbol)
...
decBasic (PairIsBasic x1 y1) (FinIsBasic n2)     = No (negEqSymBasic uninhFinPair)
